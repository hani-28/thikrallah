...
import com.HMSolutions.thikrallah.quran.labs.androidquran.util.CopyDatabaseUtil;
...
public class QuranDataActivity extends Activity implements
  ...
  private void checkPermissions() {
    ...
    boolean usesExternalFileDir = path != null && path.contains("com.HMSolutions.thikrallah.quran");
